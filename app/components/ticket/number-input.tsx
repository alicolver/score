...
export default function NumberInput(): React.JSX.Element {
    ...
    return (<div className="flex p-2 items-center">
        <Button disabled={value === 0} size="sm" isIconOnly className="rounded-3xl mr-3 bg-gradient-to-r from-sky-500 from-10% to-emerald-500 to-90%" onClick={handleDecrease}>
        ...
        <Button disabled={value === 19} size="sm" isIconOnly className="rounded-3xl ml-3 bg-gradient-to-r from-sky-500 from-10% to-emerald-500 to-90%" onClick={handleIncrease}>
            <svg xmlns={"http://www.w3.org/2000/svg"} height="32px" viewBox="0 -960 960 960" width="32px"
                 fill="#FFFFFF">
